...
import cv2
'RGB'
img = cv2.imread("C:\\Users\\ASUS PC\\PycharmProjects\\pythonProject\\LAB 1\\SangharHH.tif")
img2 = cv2.imread("C:\\Users\\ASUS PC\\PycharmProjects\\pythonProject\\LAB 1\\SangharHH.tif")
...
"""try:
    # Read image from disk.
    img = cv2.imread("C:\\Users\\ASUS PC\\PycharmProjects\\pythonProject\\LAB 1\\SangharHH.tif")
    img2 = cv2.imread("C:\\Users\\ASUS PC\\PycharmProjects\\pythonProject\\LAB 1\\SangharHV.tif")
...
'image statistics'
"""img = Image.open("C:\\Users\\ASUS PC\\PycharmProjects\\pythonProject\\LAB 1\\SangharHH.tif")
img2 = Image.open("C:\\Users\\ASUS PC\\PycharmProjects\\pythonProject\\LAB 1\\SangharHV.tif")
...
"""a=rasterio.open("C:\\Users\\ASUS PC\\PycharmProjects\\pythonProject\\LAB 1\\SangharHH.tif")
b=rasterio.open("C:\\Users\\ASUS PC\\PycharmProjects\\pythonProject\\LAB 1\\SangharHV.tif")
img = Image.open("C:\\Users\\ASUS PC\\PycharmProjects\\pythonProject\\LAB 1\\SangharHH.tif")
img2 = Image.open("C:\\Users\\ASUS PC\\PycharmProjects\\pythonProject\\LAB 1\\SangharHV.tif")
width= a.width
height=a.height
